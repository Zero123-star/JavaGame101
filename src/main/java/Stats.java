...
public class Stats {
    ...
    public Map<String, Integer> Get_Permanent_Stats() {
        // Returns the permanent stats of the player
        // Used for saving to a file, or displaying them
        return PERMANENT_STATS;
    }
    public Map<String, ArrayList<Value_and_Turns>> Get_Temporary_Stats() {
        // Returns the temporary stats of the player
        // Used for saving to a file, or displaying them
